...
create schema pltsql;
update pg_settings set setting = 'pltsql,' || setting where name = 'search_path';
...
$$ language pltsql immutable strict;
...
create function error2(p_name_table text) returns text language pltsql as $$
begin
...
DO LANGUAGE pltsql $$begin return 1; end$$;
...
create function arrayassign1() returns text[] language pltsql as $$
declare
 r record;
begin
