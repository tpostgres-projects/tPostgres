 ...
 * plugin_helpers.h
 *
 *	  Helper function prototypes for PL/TSQL instrumentation plugins
 *
...
static Oid 	   funcGetOid( PLTSQL_function * func );								/* Given a function descriptor, return the pg_proc OID	*/
static Oid 	   funcGetPkgOid( PLTSQL_function * func );							/* Given a function descriptor, return the package OID	*/
