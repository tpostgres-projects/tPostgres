 ...
 * plugin_helpers.c
 *
 *	  Helper functions for PL/TSQL instrumentation plugins
 *
 ...
 * funcGetOid()
 *
 *  Given a pointer to a PLTSQL_function structure, funcGetOid() 
 *  returns the OID of the pg_proc tuple that defines that function.
 * -------------------------------------------------------------------
 */

Oid funcGetOid( PLTSQL_function * func )
{
	return( func->fn_oid );
}
 ...
 * funcGetPkgOid()
 *
 *  Given a pointer to a PLTSQL_function structure, funcGetPkgOid() 
 *  returns the OID of the edb_package tuple that defines the function.
 * -------------------------------------------------------------------
 */

Oid funcGetPkgOid( PLTSQL_function * func )
{
	return( InvalidOid );
}
